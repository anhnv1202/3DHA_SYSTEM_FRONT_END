  ...
  return (
    <>
      <nav className="pagination-module--container--1Dmb0">
        <Link
          className="ud-btn ud-btn-medium ud-btn-secondary ud-btn-round ud-heading-sm ud-btn-disabled ud-btn-icon ud-btn-icon-medium ud-btn-icon-round pagination-module--prev--1K-2u"
          to={''}
        >
        ...
        <span className="ud-heading-sm pagination-module--page--1Ujec">231</span>
        <Link
          to="/courses/search/?p=2&amp;q=ai&amp;ratings=4.5&amp;sort=relevance&amp;src=ukw"
          className="ud-btn ud-btn-medium ud-btn-secondary ud-btn-round ud-heading-sm ud-btn-icon ud-btn-icon-medium ud-btn-icon-round pagination-module--next--1CIKT"
        >
